<!DOCTYPE html>
<%@ page import="pe.edu.pucp.iweb.trabajo.Beans.BPedidoHistorial" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ page import="java.util.ArrayList" %>
<jsp:useBean type="java.util.ArrayList<pe.edu.pucp.iweb.trabajo.Beans.BPedidoHistorial>" scope="request" id="listaHistorialPedidos"/>
			...
			<div class="table-responsive shopping-cart">
				<table class="table">
					...
					<tbody>
						<%
							int i = 1;
							for (BPedidoHistorial pedidoHistorial : listaHistorialPedidos) {
						%>
						<tr>
							<td class="text-center text-lg text-medium"><%=i++%></td>
