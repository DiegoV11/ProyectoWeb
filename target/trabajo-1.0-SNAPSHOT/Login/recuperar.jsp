                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" action="<%=request.getContextPath()%>/RecuperarContrasena" class="register-form" id="register-form">
                            ...
                            <div class="form-group form-button">
                                ...
                                <div style="display:flex; align-items:center; justify-content:center;" class="column"><button  type="submit" style="width:150px" class="btn btn-success" data-bs-toggle="modal" href="#exampleModalToggle" onclick="alert('Se ha enviado el codigo de recuperacion a su correo')">Recuperar</button></div>
							</div>
                        </form>
                    </div>
