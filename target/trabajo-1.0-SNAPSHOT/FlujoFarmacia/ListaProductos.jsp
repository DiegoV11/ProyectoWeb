<!DOCTYPE html>
<%@ page import="pe.edu.pucp.iweb.trabajo.Beans.BProducto" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ page import="java.util.ArrayList" %>
<jsp:useBean type="java.util.ArrayList<pe.edu.pucp.iweb.trabajo.Beans.BProducto>" scope="request" id="listaProductos"/>
<jsp:useBean type="pe.edu.pucp.iweb.trabajo.Beans.BFarmacia" scope="request" id="farmacia"/>;
